# [Equalize All Prefix Sums](https://www.geeksforgeeks.org/problems/optimal-array--170647/1)
## Medium
...
Input: arr[] = [1, 6, 9, 12]
Output: [0, 5, 8, 14]
Explanation: For i = 0, prefix [1] already has all equal elements, so operations = 0.
...
Constraints:1 ≤ arr.size() ≤ 105-104 ≤ arr[i] ≤ 104Sum of n over all test case does not exceed 106.